...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/RS_Movie'),
        InlineKeyboardButton('💬 Support', url='https://t.me/RS_Movie')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/RS_Movie')
        ]]
